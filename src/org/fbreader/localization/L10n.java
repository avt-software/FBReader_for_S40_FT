...
package org.fbreader.localization;
...
public class L10n {
     ...
     */
    /**
     * Full path to the messages resource bundle. Feel free to change it if you
     * don't use the message bundle file generated by IDE.
     */    
    private static final String _MESSAGES_BUNDLE = "/locale/messages.properties";
    /**
     * Error message used in the case there is any problem with initialization
     * of localization support. Please note, the error message should contain
    ...
    /**
     * Default String is returned from getMessage() methods when there is any
     * problem with finding the appropriate localized message or any part of it.
     */    
    private static final String _DEFAULT_STRING = "Error. Not find localized message.";
     ...
     * can get reason by using {@link #getErrorMessage()} method.
     *
    ...
    /**
     * Explicit initialization of the localization support. This method is
     ...
     * initialize the localization support (by calling
     * <CODE>initLocalizationSupport("fr");</CODE>) before using
    ...
    /**
     * @return currently set locale (obtained from "microedition.locale" system property).
     */
     ...
     * <CODE>_INIT_LOCALIZATION_ERROR_MSG</CODE>.
     *
     ...
     * then  <CODE>_DEFAULT_STRING</CODE> string is returned
     */    
    ...
    /**
     * Contains an error message if there was any problem with localization
     * support. If everything is OK, this field is null.
     */    
