...
public class MyLibViewListHelpForm extends Form
                      implements View, CommandListener {

    private ViewMaster viewMaster;
    
    public MyLibViewListHelpForm() {
    ...
    /**
     * Activate MyLibViewListHelpForm
     */
    ...
    /**
     * Deactivate MyLibViewListHelpForm
     */
    ...
    private void showHelp() {
        StringItem stringItemHelp = 
                   new StringItem(L10n.getMessage("MY_LIB_VIEW_LIST_FORM_HELP_TEXT_HEADER"),
                                  L10n.getMessage("MY_LIB_VIEW_LIST_FORM_HELP_TEXT"));
