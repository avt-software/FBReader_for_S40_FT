...
public class MyLibAuthorsViewListHelpForm extends Form
                      implements View, CommandListener {

    private ViewMaster viewMaster;
    
    public MyLibAuthorsViewListHelpForm() {
    ...
    /**
     * Activate MyLibAuthorsViewListHelpForm
     */
    ...
    /**
     * Deactivate MyLibAuthorsViewListHelpForm
    */
    ...
    private void showHelp() {
        ...
        StringItem stringItemHelp = 
                   new StringItem(L10n.getMessage("MY_LIB_AUTHORS_VIEW_LIST_FORM_HELP_TEXT_HEADER"),
                                  L10n.getMessage("MY_LIB_AUTHORS_VIEW_LIST_FORM_HELP_TEXT"));
