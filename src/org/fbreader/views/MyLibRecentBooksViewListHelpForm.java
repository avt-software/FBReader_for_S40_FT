...
public class MyLibRecentBooksViewListHelpForm extends Form
                      implements View, CommandListener {

    private ViewMaster viewMaster;
    
    public MyLibRecentBooksViewListHelpForm() {
    ...
    /**
     * Activate MyLibRecentBooksViewListHelpForm
     */
    ...
    /**
     * Deactivate MyLibRecentBooksViewListHelpForm
     */
    ...
    private void showHelp() {
        ...
        StringItem stringItemHelp = 
                   new StringItem(L10n.getMessage("MY_LIB_RECENT_BOOKS_VIEW_LIST_FORM_HELP_TEXT_HEADER"),
                                  L10n.getMessage("MY_LIB_RECENT_BOOKS_VIEW_LIST_FORM_HELP_TEXT"));
